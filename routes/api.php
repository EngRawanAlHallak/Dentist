...
//for multy auth
Route::middleware('auth:sanctum')->group(function () {
    Route::get('/view-all-patients', [AdminController::class, 'viewAllPatients'])->middleware('role:admin,AdmissionManager,radiologyManager');
    ...
    Route::post('/show-educational-contents' ,[StudentController::class, 'showContent'])->middleware('role:dentalStudent,doctor,supervisor');
    Route::post('/show-educational-contents-bystage' ,[StudentController::class, 'showEducationalContentByStage'])->middleware('role:dentalStudent,doctor,supervisor');
    Route::post('/patient-info' ,[StudentController::class, 'viewPatientInfo'])->middleware('role:dentalStudent,doctor,supervisor');
